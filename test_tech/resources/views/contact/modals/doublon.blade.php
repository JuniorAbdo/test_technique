    ...
    <div class="modal fade" id="contact-doublon" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body supprime-content">
              <p>
                Un contact existe déjà avec le même nom et le même prénom.
              </p>
              <p>
